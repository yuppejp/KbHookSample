    ...
    internal class KeyboardHook
    {
        ...
        public IntPtr HookProcedure(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            if (nCode >= 0 && (wParam == (IntPtr)WM_KEYDOWN || wParam == (IntPtr)WM_SYSKEYDOWN))
            {
                ...
                isHandled = OnKeyDownEvent(vkCode);
            }
            else if (nCode >= 0 && (wParam == (IntPtr)WM_KEYUP || wParam == (IntPtr)WM_SYSKEYUP))
            {
                var kb = (KBDLLHOOKSTRUCT)Marshal.PtrToStructure(lParam, typeof(KBDLLHOOKSTRUCT));
                var vkCode = (int)kb.vkCode;
                isHandled = OnKeyUpEvent(vkCode);
            }
        ...
        public delegate bool KeyEventHandler(object sender, KeyEventArg e);
        ...
        protected bool OnKeyDownEvent(int keyCode)
        {
            ...
            return KeyDownEvent.Invoke(this, new KeyEventArg(keyCode));
        }
        protected bool OnKeyUpEvent(int keyCode)
        {
            ...
            return KeyUpEvent.Invoke(this, new KeyEventArg(keyCode));
        }
    }
}
